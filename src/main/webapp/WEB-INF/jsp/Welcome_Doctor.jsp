...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav ml-auto px-lg-4">
          ...
          <li class="nav-item px-3">
            <a class="nav-link" href="displaypatient">View Documents</a>
          </li>
  ...
  <section id="homepage">
    ...
    <h4>
      ...
      <p id="p1">Place from where you can get patient medical data. </p>
    </h4>
    <p id="p2"><br> Patients' medical data contains sensitive and confidential information that must be kept securely for future reference and to ensure continuity of care. The digital age has enabled the creation of electronic medical records which can be used to store and manage medical data.</p>
  </section>
